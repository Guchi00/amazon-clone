...
const text = (
  <div className={styles.parent}>
    ...
    <a
      href="https://www.amazon.com/hz/cs/help?ref_=icp_language_help&nodeId=GARKQZZYZ542RGWK"
...
const content = (
  <div>
    ...
    <div className={styles.third_content}>
      ...
      <a
        href="https://www.amazon.com/hz/cs/help?ref_=icp_currency_help&nodeId=GDX4RY8D2M85FHLD"
        className={styles.learn_more}
        id={styles.learn_more_2nd}
      >
        Learn more
      </a>
    </div>
    ...
    <div className={styles.change_dollar}>
      ...
      <a
        href="https://www.amazon.com/customer-preferences/edit?ref_=icp_cop_flyout_change&preferencesReturnUrl=%2F%3Flanguage%3Den_US"
    ...
    <div className={styles.shop_on_amazon}>
      ...
      />
      <span className={styles.shopping_text}>
        You are shopping on <br></br>Amazon.com
      </span>
    </div>

    <div className={styles.change_country_region}>
      <a
        href="https://www.amazon.com/customer-preferences/country?ref_=icp_lop_mop_chg_ais&preferencesReturnUrl=/"
